...
export default async function NowPlayingMoviesPage({ searchParams }:any) {
  
  const currentPage = parseInt(searchParams?.page || '1', 10);
  

  const moviesData = await getNowPlayingMovies(currentPage);
  
  // Película destacada (solo en primera página)
